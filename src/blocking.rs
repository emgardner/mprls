    ...
    D: DelayNs,
{
    ...
    pub fn read_pressure(&mut self, pu: PressureUnit) -> Result<f32, Error<E>> {
        let mut buffer = [0, 0, 0, 0];
        let _ = self.i2c.read(self.address as u8, &mut buffer);
    ...
    pub fn get_pressure(&mut self, pu: PressureUnit) -> Result<f32, Error<E>> {
